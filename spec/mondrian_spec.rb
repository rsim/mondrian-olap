    ...
    @schema = Mondrian::OLAP::Schema.define do
      cube 'Sales' do
        ...
        dimension 'Promotions', foreign_key: 'promotion_id' do
          hierarchy has_all: true, primary_key: 'id' do
            table 'promotions'
            level 'Promotion', column: 'id', name_column: 'promotion', unique_members: true, ordinal_column: 'sequence',
              type: 'Numeric'
          end
        end
        dimension 'Linked Promotions', foreign_key: 'customer_id' do
          hierarchy has_all: true, primary_key: 'id', primary_key_table: 'customers' do
            ...
            level 'Promotion', column: 'id', name_column: 'promotion', unique_members: true, table: 'promotions',
              ordinal_column: 'sequence', type: 'Numeric', approx_row_count: 10
          end
        end

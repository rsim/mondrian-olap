...
Gem::Specification.new do |gem|
  ...
  gem.add_development_dependency "jdbc-mysql", "~> 8.0.17"
  gem.add_development_dependency "jdbc-postgres", "~> 42.2.14"
  gem.add_development_dependency "jdbc-jtds", "~> 1.3.1"
  gem.add_development_dependency "activerecord", "~> 4.2.11"
  gem.add_development_dependency "activerecord-jdbc-adapter", "~> 1.3.25"
  gem.add_development_dependency "activerecord-oracle_enhanced-adapter", "~> 1.6.9"
